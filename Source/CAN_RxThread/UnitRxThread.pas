...
uses
  Dialogs, VCI3Error, Windows, UnitMain;
...
begin
  repeat
    // wait 50 milli seconds for a CAN message
    if (canChannelWaitRxEvent(m_hCanChn, 50) = VCI_OK) then
    begin
...
begin
  FormMain.ShowCANMessage (m_sCanMsg);
end;
